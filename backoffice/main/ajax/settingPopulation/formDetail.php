<?php
    ...
    $rs_lvl1 = $db_r4->prepare($sql_lvl1);
    $rs_lvl1->execute();
    $results_lvl1 = $rs_lvl1->fetchAll();
    //---------------------------------------------------------------------------------------
    $sql_lvl2 = "SELECT  dpl2.year,da.Province_CODE AS province_code , da.Province_NAME AS province_name, dpl2.population AS population 
...
?>
    ...
    <div class="modal-body">
        <ul class="nav nav-tabs mb-3" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="lvl2-tab" data-toggle="tab" href="#lvl2" role="tab" aria-controls="lvl2" aria-selected="false">จังหวัด</a>
            </li>
            <!-- <li class="nav-item">
