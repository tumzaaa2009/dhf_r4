...
?>
    <div class="modal-header bg-secondary-gradient">
        <h4 class="modal-title">นำเข้าข้อมูล txt.</h4>
    </div>
    <div class="modal-body">
        <form id="ImportFile" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <label for=""><strong> นำเข้าข้อมูล txt.</strong><span class="text-danger">*</span> 
                    </label>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="fileImport" id="fileImport" onchange="readURLtxt(this,value,'#blah');">
