<?php
    ...
    $resultSQL_lvl1 = $db_r4->exec($sql_insert_lvl1);
    ...
    if($resultSQL_lvl1 == "1"){
        ...
        $resultSQL_lvl3 = $db_r4->exec($sql_insert_lvl3);

        if($resultSQL_lvl3 > 1){
            $sql_edit = "UPDATE dhf_calendar_lvl3 SET week = WEEK(date,2) WHERE year = '$year'";
            $result_update = $db_r4->exec($sql_edit);
            ...
            if($result_update > 1){
                ...
                $resultSQL_lvl2 = $db_r4->exec($sql_insert_lvl2);
